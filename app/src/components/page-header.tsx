                        ...
                        <ol className="inline-flex items-center gap-1">
                            {defaultBreadcrumbs.map((item, index) => (
                                <li key={index} className="inline-flex items-center">
                                    ...
                                    {item.active ? (
                                        <span className="text-sm font-medium text-background opacity-70">{item.name}</span>
                                    ) : (
                                        <a href={item.href} className="text-sm font-medium text-blue-400 hover:text-blue-300">
                                            {item.name}
                                        </a>
                                    )}
                                </li>
