...
import { Play, Square, RotateCcw, Trash2, Globe, Folder, Lock, ExternalLink } from "lucide-react";
                    ...
                    <div className="flex-1 min-w-0 space-y-2">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="space-y-1">
                                <h3 className="text-lg font-semibold leading-none tracking-tight text-foreground truncate" title={website.name}>
                ...
                <div className="space-y-3">
                    <div className="flex items-center gap-3 rounded-md border border-muted bg-background/50 p-3">
                        ...
                        <div className="flex-1 min-w-0 space-y-1">
                            ...
                            <p className="text-sm font-mono text-foreground truncate" title={website.physicalPath}>
