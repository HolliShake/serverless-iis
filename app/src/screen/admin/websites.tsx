...
import { useQuery, useMutate } from "@/hooks/query";
...
export default function AdminWebsites() {
    ...
    const { data, query, isLoading: loading, refetch } = useQuery({
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:justify-between lg:items-center">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                        <label className="text-background font-medium text-sm sm:text-base">Filter by status:</label>
                        <Select
                            items={filters}
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                            <label className="text-background font-medium text-sm sm:text-base whitespace-nowrap">Search:</label>
                            <Input
                                type="text"
                                value={searchQuery}
